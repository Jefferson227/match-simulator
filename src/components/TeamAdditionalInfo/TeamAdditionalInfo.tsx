...
const TeamAdditionalInfo: React.FC<TeamAdditionalInfoProps> = ({
  ...
  return (
    <div className="bg-green-500 text-white font-mono p-5 border-4 border-black max-w-md mx-auto shadow-[0_0_0_4px_white,0_0_0_8px_black]">
      ...
      <div className="flex justify-between mt-5">
        <button 
          className="bg-transparent border-2 border-white text-white px-4 py-2 font-mono text-sm transition-all hover:bg-white/20 active:translate-y-px"
          onClick={onPrevious}
        >
          &lt;
        </button>
